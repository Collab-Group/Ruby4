...
namespace MOSA1.Apps
{
    class SystemInfo : Window
    {
        ...
        public string ahcisata = AHCI.AHCI_DEV_SATA.ToString();
        public string smbiosver = SmbiosManager.MajorVersion.ToString();
        ...
        public override void UIUpdate()
        {
            ...
            System.Graphics.DrawBitFontString(System.DefaultFontName, 0x0, "SMBIOS Version: " + smbiosver, X, Y + 14);
            ...
            System.Graphics.DrawBitFontString(System.DefaultFontName, 0x0, "AHCI SATA Drives: " + ahcisata, X, Y + 120);
        }
    }
    }
